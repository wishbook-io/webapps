(function() {
    ...
    adjustmentController.$inject = ['$resource', 'SyncOICSV', 'Warehouse', 'ngDialog', 'toaster', '$scope', 'DTOptionsBuilder', 'DTColumnDefBuilder', 'DTColumnBuilder', 'CheckAuthenticated', '$compile', '$state', 'Upload'];
    function adjustmentController($resource, SyncOICSV, Warehouse, ngDialog, toaster, $scope, DTOptionsBuilder, DTColumnDefBuilder, DTColumnBuilder, CheckAuthenticated, $compile, $state, Upload) {
        ...
        vm.dtOptions = DTOptionsBuilder.newOptions()
                        .withOption('ajax', {
                            url: 'api/inventoryadjustmentdatatables/',
                            type: 'GET',
                        })

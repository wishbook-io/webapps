(function () {
    ...
    angular
        ...
        .controller('pendingorderitemssellerspecificController', pendingorderitemssellerspecificController);
    pendingorderitemssellerspecificController.$inject = ['$resource', '$state', 'PendingOrderItemsAction', 'djangoAuth', '$stateParams', 'SalesOrders', 'Upload', 'SalesOrdersforInvoice', 'Company', 'Category', 'CompanyPhoneAlias', 'CompanyPricelist', 'CompanyBuyergroupRule', 'BrandDistributor', 'grouptype', '$scope', 'CheckAuthenticated', 'toaster', '$location', 'SidebarLoader', '$rootScope', 'DTOptionsBuilder', 'DTColumnDefBuilder', 'DTColumnBuilder', '$compile', 'ngDialog', '$cookies', '$localStorage'];
    function pendingorderitemssellerspecificController($resource, $state, PendingOrderItemsAction, djangoAuth, $stateParams, SalesOrders, Upload, SalesOrdersforInvoice, Company, Category, CompanyPhoneAlias, CompanyPricelist, CompanyBuyergroupRule, BrandDistributor, grouptype, $scope, CheckAuthenticated, toaster, $location, SidebarLoader, $rootScope, DTOptionsBuilder, DTColumnDefBuilder, DTColumnBuilder, $compile, ngDialog, $cookies, $localStorage) {
        ...
        $scope.ordertype = "";
        $scope.actiontype = "";
        $scope.sellerName = $stateParams.company_name;
        ...
        vm.dtOptions = DTOptionsBuilder.newOptions()
            .withOption('ajax', {
                url: 'api/pendingorderitemsadmindatatables/?company_id='+$stateParams.company_id,
                type: 'GET',
            })
            ...
            .withOption('stateSaveCallback', function (settings, data) {
                ...
                localStorage.setItem('DataTables_' + 'pendingorders_sellerwise', JSON.stringify(data));
            })
            .withOption('stateLoadCallback', function (settings) {
                return JSON.parse(localStorage.getItem('DataTables_' + 'pendingorders_sellerwise'))
            })
            ...
            .withButtons([
                {
                    ...
                    action: function (e, dt, node, config) {
                        ...
                        localStorage.removeItem('DataTables_' + 'pendingorders_sellerwise');
                        $state.go($state.current, {}, { reload: true });
                    }
                },
                {
        ...
        vm.dtColumnDefs = [
            ...
            DTColumnDefBuilder.newColumnDef(3).withTitle('Seller'),
            ...
            DTColumnDefBuilder.newColumnDef(16).withTitle('Seller phone').notVisible().notSortable(),

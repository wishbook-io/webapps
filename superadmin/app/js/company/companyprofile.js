              ...
              if(data.companyuser != null)
              {
                 ...
                 else
                 {
                  ...
                  Company.get({id: $scope.companyId}).$promise.then(function(result) {
                       ...
                       {
                          vm.catArr.push(result.category[i]);
                       }
                       ...
                       // $scope.categories = Category.query({parent: "null"},function (success){
                        $scope.categories = Category.query({parent: 10},function (success){
                             //   alert($scope.categories.length);
                            //     vm.catArr = [];
                                categoryTree(vm.catArr);
                        ...
                        function (error)
                        {
                         vm.errortoaster = {
                                  type:  'error',
                                  title: 'Failed',
                                  text:  'Not able to fetch Category Tree.'
                              };

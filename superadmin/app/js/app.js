...
(function() {
    ...
    angular
        .module('wishbook', [
            ...
            'app.administrators',
            'app.salesorders',
            'app.pendingorderitems-itemwise',
            'app.pendingorderitems-sellerwise',
            'app.pendingorderitems-sellerspecific',
            'app.purchaseorders',
            'app.adminpurchaseorders',
            'app.orderscreens',
            'app.brokerageorders',
...
(function() {
    ...
    angular
        .module('app.resellerpayouts', ['ngSanitize']);
})();
(function() {
    'use strict';

    angular
        .module('app.resellerpayoutsitems', ['ngSanitize']);
})();
(function() {
    'use strict';

    angular
        .module('app.accounts', ['ngSanitize']);
})();
(function() {
    'use strict';
...
(function () {
    ...
    angular
        .module('app.pendingorderitems-sellerspecific', []);
})();
    ...
    angular
        ...
        .constant('APP_REQUIRES', {
          ...
          modules: [
            ...
            {name: 'dashboardCtlr',        files: ['app/js/dashboard/dashboard.js']},
            ...
            {name: 'screensCtlr',        files: ['app/js/screens/screens.js',
                                                 'app/js/common/company_detail_edit.js',
                                                 'wishbook_libs/js/catalogaction/add_update.js']},

            {name: 'resellerPayoutsCtlr',        files: ['app/js/reseller/resellerpayouts.js']},
            {name: 'resellerPayoutsItemsCtlr',        files: ['app/js/reseller/resellerpayoutsitems.js']},
            {name: 'accountsCtlr',        files: ['app/js/accounts/finance_exports.js']},
            ...
            {name: 'pendingordersitemwiselistCtlr', files: ['app/js/pendingorders/pendingorderitems-itemwise.js',
                                                                    //'app/js/common/company_detail.js',
                                                                    'app/js/common/company_detail_edit.js']
                                                    },
            {name: 'pendingorderssellerwiselistCtlr', files: ['app/js/pendingorders/pendingorderitems-sellerwise.js',
                                                                //'app/js/common/company_detail.js',
                                                                    'app/js/common/company_detail_edit.js']
                                                    },
            {name: 'pendingorderssellerSpecificlistCtlr', files: ['app/js/pendingorders/pendingorderitems-sellerspecific.js']
                                                        },
            {name: 'purchaseorderslistCtlr',  files: ['vendor/hmac-sha256/hmac-sha256.js',
                                                      ...
                                                      'vendor/hmac-sha256/enc-base64-min.js',
                                                      'app/js/common/orderstatus.js']}, 
            {name: 'adminpurchaseorderslistCtlr', files: ['app/js/purchaseorders/purchaseorders.js',
                                                          'wishbook_libs/js/shipment/create_shipment.js']},
            // {name: 'orderScreensListCtlr', files: ['app/js/order/orderscreens.js']}, 
            ...
            {name: 'companiesCtlr',        files: ['app/js/companies/company.js',
                                                    'wishbook_libs/js/brand/brand_action.js',
                                                    'app/js/common/company_detail_edit.js']},
            ...
            {name: 'brandwiseDiscountCtlr',        files: ['app/js/brandwisediscount/brandwisediscount.js',
            ...
            {name: 'printResellerInvoiceCtlr',  files: ['vendor/JsBarcode-master/dist/JsBarcode.all.min.js',
                                                'wishbook_libs/js/invoice/printresellerinvoice.js']},
...
angular.module('wishbook')
  .factory('RRC', function ($state, $resource) {
      return $resource('api/v1/rrc-requests/:id/:sub_resource/?format=json', {id: '@id', sub_resource: '@sub_resource'}, {
            update: {
                    method: 'PUT'
            },
            patch: {
...
angular.module('wishbook')
    .factory('Shipments', function ($state, $resource) {
        return $resource('api/v1/companies/:cid/shipments/:id/:sub_resource/?format=json', { id: '@id', cid: '@cid', sub_resource: '@sub_resource'}, {
            patch: {
                method: 'PATCH'
            },
            save: {
...
angular.module('wishbook')
  .factory('EnumGroup', function ($state, $resource) {
      return $resource('api/v2/enumgroup/',  {
...
// Bee Factory
angular.module('wishbook')
  .factory('ExBee', function ($state, $resource) {
      return $resource('api/v1/bee-manifest/?format=json', {
            save:{
                    method: 'POST'
            }
      });
...
angular.module('wishbook')
  .factory('ResellerPay', function ($state, $resource) {
      return $resource('api/v1/reseller-pay/?format=json', {
            update: {
                    method: 'PUT'
            },
            patch: {
...
angular.module('wishbook')
  .factory('FinanceExport', function ($state, $resource) {
      return $resource('api/v1/finance-export/?format=json', {
...
angular.module('wishbook')
  .factory('v2Carts', function ($state, $resource) {
      return $resource('api/v2/companies/:cid/carts/:id/:sub_resource/?format=json', {id: '@id', cid:'@cid', sub_resource: '@sub_resource'}, {
            patch: {
                    method: 'PATCH'
            },
            save:{
...
angular.module('wishbook')
  .factory('v2PurchaseOrders', function ($state, $resource) {
      return $resource('api/v2/companies/:cid/purchase-orders/:id/:sub_resource/?format=json', {id: '@id', cid:'@cid', sub_resource: '@sub_resource'}, {
            patch: {
                    method: 'PATCH'
            },
            save:{
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper, $httpProvider){
      ...
      //  console.log(fullurl);
        ...
        $stateProvider
          ...
          .state('app.dashboard', {
              ...
              resolve: angular.extend(
               helper.resolveFor('dashboardCtlr','toaster'), {
          ...
          .state('app.companies', {
             ...
             // controllerAs: 'cat',
              resolve: angular.extend(
               helper.resolveFor('companiesCtlr', 'ngFileUpload', 'parsley', 'ui.select','localytics.directives', 'toaster', 'angular-datatables','ngDialog', 'oitozero.ngSweetAlert'), {
                authenticated : 'CheckAuthenticated'
               }
              )
          })
        ...
        .state('app.brandwisediscount', {
              url: '/brandwisediscount',
              title: 'Brandwise Discount',
              templateUrl: helper.basepath('brandwisediscount/brandwisediscount.html'),
             // controller: 'CatalogFormController',
             // controllerAs: 'cat',
              resolve: angular.extend(
               helper.resolveFor('brandwiseDiscountCtlr', 'parsley','ngFileUpload','ui.select','angular-datatables','ngDialog','localytics.directives', 'toaster'), {
                authenticated : 'CheckAuthenticated'
               }
              )
          })
          ...
          .state('app.order', {
             ...
             params: { order_type: null, order_status:null, processing_status:null},
              resolve: angular.extend(
               helper.resolveFor('orderCtlr', 'parsley', 'ui.select','localytics.directives', 'toaster', 'angular-datatables','ngDialog', 'oitozero.ngSweetAlert'), {
                authenticated : 'CheckAuthenticated'
               }
              )
          })
        ...
        /*  .state('app.discount', {
          ...
          .state('app.contactus', {
             ...
             resolve: angular.extend(
               helper.resolveFor('localytics.directives', 'toaster'), {
                authenticated : 'CheckAuthenticated'
               }
              )
          })
          ...
          .state('app.screens', {
              url: '/screens',
              title: 'Screens',
              templateUrl: helper.basepath('screens/screens.html'),
             // controller: 'CatalogFormController',
             // controllerAs: 'cat',
              resolve: angular.extend(
          ...
          .state('app.resellerpayouts', {
              url: '/resellerpayouts',
              title: 'Reseller Payouts',
              templateUrl: helper.basepath('reseller/resellerpayouts.html'),
             // controller: 'CatalogFormController',
             // controllerAs: 'cat',
              resolve: angular.extend(
               helper.resolveFor('resellerPayoutsCtlr', 'parsley', 'ngFileUpload','uiCropper','ui.select','localytics.directives', 'toaster', 'ngJstree','angular-datatables','ngDialog','imageCompressor', 'angular-carousel', 'oitozero.ngSweetAlert', 'photoSwipe'), {
                authenticated : 'CheckAuthenticated'
               }
              )
          })

          .state('app.resellerpayoutsitems', {
              url: '/resellerpayoutsitems/?:settlement_id',
              title: 'Reseller Payouts Items',
              templateUrl: helper.basepath('reseller/resellerpayoutsitems.html'),
             // controller: 'CatalogFormController',
             // controllerAs: 'cat',
              resolve: angular.extend(
               helper.resolveFor('resellerPayoutsItemsCtlr', 'parsley', 'ngFileUpload','uiCropper','ui.select','localytics.directives', 'toaster', 'ngJstree','angular-datatables','ngDialog','imageCompressor', 'angular-carousel', 'oitozero.ngSweetAlert', 'photoSwipe'), {
                authenticated : 'CheckAuthenticated'
               }
              )
          })
          ...
          .state('app.accounts', {
              url: '/accounts',
              title: 'Accounts',
              templateUrl: helper.basepath('accounts/finance_exports.html'),
              resolve: angular.extend(
               helper.resolveFor('accountsCtlr', 'parsley', 'ngFileUpload','uiCropper','ui.select','localytics.directives', 'toaster', 'ngJstree','angular-datatables','ngDialog','imageCompressor', 'angular-carousel', 'oitozero.ngSweetAlert'), {
                authenticated : 'CheckAuthenticated'
               }
              )
          })
     ...
     //         controller: 'SalesorderslistController',
          ...
          .state('app.purchaseorders', {
            ...
            .state('app.adminpurchaseorders', {
                url: '/adminpurchaseorders',
                title: 'Purchase Orders',
                templateUrl: helper.basepath('purchaseorders/purchaseorders.html'),
                resolve: angular.extend(
                    helper.resolveFor('adminpurchaseorderslistCtlr', 'ui.select', 'angular-datatables', 'ngDialog', 'toaster', 'localytics.directives', 'xeditable', 'parsley', 'ngFileUpload'), {
                        authenticated: 'CheckAuthenticated'
                    }
                )
            })
            /*.state('app.orderscreens', {
                url: '/orderscreens',
                title: 'Orders Screens',
                templateUrl: helper.basepath('order/orderscreens.html'),
                resolve: angular.extend(
                    helper.resolveFor('orderScreensListCtlr', 'ui.select', 'angular-datatables', 'ngDialog', 'toaster', 'localytics.directives', 'xeditable', 'parsley', 'ngFileUpload'), {
                        authenticated: 'CheckAuthenticated'
                    }
                )
            })*/

            .state('app.pendingorderitems-itemwise', {
                url: '/pendingorderitems-itemwise',
                title: 'Pending Orders items : itemwise',
                templateUrl: helper.basepath('pendingorders/pendingorderitems-itemwise.html'),
                resolve: angular.extend(
                    helper.resolveFor('pendingordersitemwiselistCtlr', 'ui.select', 'angular-datatables', 'ngDialog', 'toaster', 'localytics.directives', 'parsley', 'ngFileUpload'), {
                        authenticated: 'CheckAuthenticated'
                    }
                )
            })
            .state('app.pendingorderitems-sellerwise', {
                url: '/pendingorderitems-sellerwise',
                title: 'Pending Orders items : sellerwise',
                templateUrl: helper.basepath('pendingorders/pendingorderitems-sellerwise.html'),
                resolve: angular.extend(
                    helper.resolveFor('pendingorderssellerwiselistCtlr', 'ui.select', 'angular-datatables', 'ngDialog', 'toaster', 'localytics.directives', 'parsley', 'ngFileUpload'), {
                        authenticated: 'CheckAuthenticated'
                    }
                )
            })

            .state('app.pendingorderitems-sellerspecific', {
                url: '/pendingorderitems-sellerspecific/?:company_id&:company_name',
                title: 'Pending Orders items : Specific seller',
                templateUrl: helper.basepath('pendingorders/pendingorderitems-sellerspecific.html'),
                params: { company_id: null, company_name: null},
                resolve: angular.extend(
                    helper.resolveFor('pendingorderssellerSpecificlistCtlr', 'ui.select', 'angular-datatables', 'ngDialog', 'toaster', 'localytics.directives', 'parsley', 'ngFileUpload'), {
                        authenticated: 'CheckAuthenticated'
                    }
                )
            })
       ...
       /*   .state('app.brokerageorders', {
        ...
        /*  .state('page.register', {
          ...
          .state('pages.printresellerinvoice', {
              url: '/printresellerinvoice/?:invoice',
              title: 'Print Reseller Invoice',
              templateUrl: 'wishbook_libs/views/invoice/printresellerinvoice.html',
              params: { salesorder: null, purchaseorder:null},
              resolve: angular.extend(
               helper.resolveFor('printResellerInvoiceCtlr', 'toaster'), {
                authenticated : 'CheckAuthenticated'
               }
              )
          })
...
function openPhotoSwipe(catalog, catalog_products, catalog_type) {

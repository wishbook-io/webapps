(function() {
    ...
    angular
        ...
        .controller('MyFollowerslistController', MyFollowerslistController);

    MyFollowerslistController.$inject = ['$http', '$resource', '$scope', 'toaster', 'Country', 'ngDialog', 'DTOptionsBuilder', 'DTColumnDefBuilder', 'DTColumnBuilder', '$compile', '$state', 'CheckAuthenticated', 'Upload', 'resendsupplier', '$cookies', '$localStorage'];
    function MyFollowerslistController($http, $resource,  $scope, toaster, Country, ngDialog,  DTOptionsBuilder, DTColumnDefBuilder, DTColumnBuilder, $compile, $state, CheckAuthenticated, Upload, resendsupplier, $cookies, $localStorage) {
     ...
     /*   vm.dtColumnDefs = [
        ...
        vm.dtColumnDefs = [
           DTColumnDefBuilder.newColumnDef(0).withTitle(titleHtml).notSortable()
            ...
            DTColumnDefBuilder.newColumnDef(2).withTitle('Follower\'s Name'),
            DTColumnDefBuilder.newColumnDef(3).withTitle('State'),
            DTColumnDefBuilder.newColumnDef(4).withTitle('City'),
            DTColumnDefBuilder.newColumnDef(5).withTitle('Brand name'),
            DTColumnDefBuilder.newColumnDef(6).withTitle('Action').notSortable()//.withOption('width', '25%')
                .renderWith(function(data, type, full, meta) {
                    var htmlbutton = ''

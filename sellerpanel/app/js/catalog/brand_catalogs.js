(function() {
    ...
    function BrandCatalogsController($resource, Catalog, ngDialog, toaster, $scope, DTOptionsBuilder, DTColumnDefBuilder, DTColumnBuilder, CheckAuthenticated, $compile, $state, $filter, $stateParams, SweetAlert, Suppliers) {
        ...
        $scope.paramString = '?brand='+$stateParams.brand;

        console.log($stateParams);

        if ($stateParams.type != 'public') {
            $scope.paramString +='&type=mycatalog';
        }
        ...
        function imageHtml(data, type, full, meta){
            ...
            return '<a ng-click="OpenProductsImages(' + full[0] + ',' + full[6] +')" class="hvr-grow"><img class="loading" src="'+full[2]+'" style="width: 100px; height: 100px"/></a>';
        }
    ...
    //    buttons.push('print');
        ...
        vm.dtOptions = DTOptionsBuilder.newOptions()
                      .withOption('ajax', {
                          url: 'api/brandscatalogdatatables/'+$scope.paramString,
                          //url: 'api/brandscatalogdatatables/?brand=722&type=mycatalog',
                          type: 'GET',
                      })
                      .withDOM('rtipl')

(function() {
    ...
    angular
        ...
        .controller('BuyerSalesOrderController', BuyerSalesOrderController);

    BuyerSalesOrderController.$inject = ['$resource', 'toaster', '$scope', 'DTOptionsBuilder', 'DTColumnDefBuilder', 'DTColumnBuilder', 'CheckAuthenticated', '$compile', '$state', '$filter', '$stateParams'];
    function BuyerSalesOrderController($resource, toaster, $scope, DTOptionsBuilder, DTColumnDefBuilder, DTColumnBuilder, CheckAuthenticated, $compile, $state, $filter, $stateParams) {
       ...
       vm.selected = {};
        ...
        vm.dtOptions = DTOptionsBuilder.newOptions()
                      .withOption('ajax', {
                          url: 'api/salesorderdatatables1/?buying_company='+$stateParams.id,
                          type: 'GET',
                      })
            ...
            DTColumnDefBuilder.newColumnDef(7).withTitle('Order Status'),
            DTColumnDefBuilder.newColumnDef(8).withTitle('Processing Status'),
                      ];
